 ...
 * Fall 2022
 */
public class LoadController implements EventHandler<ActionEvent>, Initializable {
	...
	public void handle(ActionEvent event) {
		...
		if(buttonText!=null && buttonText.contains("Game Start!") ) {
...
//        String s = "src/application/sounds/nyancat.mp3";
//        Media h = new Media(Paths.get(s).toUri().toString());
